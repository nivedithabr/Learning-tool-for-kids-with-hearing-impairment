...
namespace block_bubcam\task;

use block_bubcam\avatargenerator;
...
class update_avatars extends scheduled_task {
    ...
    public function get_name() {
        return get_string('task:update_avatars', 'block_bubcam');
    }
    ...
    public function execute() {
        ...
        $enabled = get_config('block_bubcam', 'avatar_initials');
        if (empty($enabled)) {
            return true;
        }
