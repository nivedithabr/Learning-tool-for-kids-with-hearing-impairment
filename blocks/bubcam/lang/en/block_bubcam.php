...
$string['bubcam:addinstance'] = 'Add a avatar snapshot tool';
$string['bubcam:myaddinstance'] = 'Add a new avatar snapshot block to My home';
$string['bubcam:view'] = 'View bubcam';
...
$string['pluginname_desc'] = 'Customize Bubcam below.';
